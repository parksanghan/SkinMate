...
class ChatManager:
    ...
    def request_chat_response(self, logs, user_message):
        try:
            ...
            chat_list.insert(0, {"role": "system", "content": "You are a helpful assistant."})
...
if __name__ == "__main__":
    ...
    logs = [
        {'chat_id': 1, 'user_id': 1, 'log_type': '질의응답', 'image_path': None, 'diagnosis_result': None, 'message': '주름 개선 방법이 뭐야?', 'response': '주름 개선에는 수분크림이 효과적입니다.', 'timestamp': datetime(2025, 3, 31, 21, 55, 11)},
        {'chat_id': 2, 'user_id': 1, 'log_type': '진단분석', 'image_path': '/path/to/image.jpg', 'diagnosis_result': '{"jawline": 4, "wrinkle": 2}', 'message': None, 'response': '주름은 평균보다 많고 턱선은 준수합니다.', 'timestamp': datetime(2025, 3, 31, 21, 55, 11)}
    ]
