...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MauiApp1.Platforms.Android.Camera2Preview, MauiApp1", Camera2Preview.class, __md_methods);
	}
	...
	public Camera2Preview (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("MauiApp1.Platforms.Android.Camera2Preview, MauiApp1", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2 });
		}
	}
	...
	public Camera2Preview (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("MauiApp1.Platforms.Android.Camera2Preview, MauiApp1", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
		}
	}
	...
	public Camera2Preview (android.content.Context p0)
	{
		super (p0);
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("MauiApp1.Platforms.Android.Camera2Preview, MauiApp1", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
